    ...
    init: function () {
        Array.from(document.querySelectorAll('[placeholder]')).forEach(el => {
            if (el.getAttribute('placeholder') !== '')
                this.updatePlaceholder.call(el);

            el.addEventListener('change', this.updatePlaceholder);
            el.addEventListener('keyup', this.updatePlaceholder);
        });
    },
...
if (!matches(input, ':placeholder-shown')) placeholderShownPolyfill.init();
